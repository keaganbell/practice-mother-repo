...
struct shader_program_common {
    GLuint Handle;
};

struct default_shader_program {
    shader_program_common Common;
    // TODO: lighting stuff and all the uniform handles
};

struct final_composite_program {
    shader_program_common Common;
};
...
struct opengl {
    ...
    GLuint FBO;
    GLuint MultisampledTexture; // framebuffer color attachment
    ...
    default_shader_program DefaultProgram;
    final_composite_program FinalCompositeProgram;
};
