...
static gl_dispatch_compute *glDispatchCompute;
static gl_memory_barrier *glMemoryBarrier;
...
typedef void gl_texture_parameteri(GLuint texture, GLenum pname, GLint param);
typedef void gl_texture_storage_1d(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);
typedef void gl_texture_storage_2d(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
typedef void gl_texture_storage_3d(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
...
static gl_texture_parameteri *glTextureParameteri;
static gl_texture_storage_1d *glTextureStorage1D;
static gl_texture_storage_2d *glTextureStorage2D;
static gl_texture_storage_3d *glTextureStorage3D;
static gl_bind_image_texture *glBindImageTexture;
